...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.altiumproj.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".altiumproj" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".altiumproj")
	}
